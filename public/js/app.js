...
function initAdmin(socket) {
  ...
  socket.on('orderPlaced', function (order) {
    ...
    orders.unshift(order); // add to top of orderlist
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    //console.log(e);
    var pizza = JSON.parse(btn.dataset.pizza); //after clicking add btn ,we get data in json of paticular click
    //console.log(pizza);
    updateCart(pizza);
  });
});
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkRealTimePizza"] = self["webpackChunkRealTimePizza"] || [];
